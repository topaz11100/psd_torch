...
python -m psd_snn.cli.analyze_signal --config "${PROJECT_ROOT}/examples/configs/runnable/analyze_signal_mean_exact.json" --mode checkpoint --checkpoint "${CKPT}" --run_id "${RUN_ID}_sig_mean"
