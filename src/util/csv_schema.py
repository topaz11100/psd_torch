...
CATEGORY_COLUMNS: dict[str, tuple[str, ...]] = {
    ...
    'analysis_manifest': (*AXIS_METADATA_COLUMNS, 'checkpoint_path', 'checkpoint_epoch', 'artifact_name', 'output_csv_path', 'pca_analysis_schema_version', 'basis_id', 'reference_epoch', 'resolved_dim'),
