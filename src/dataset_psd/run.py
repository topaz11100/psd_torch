...
from src.common.dataset_psd_driver import run_dataset_psd
from src.common.datasets import dataset_choices
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument('--probe_plot', type=_parse_bool01, default=True, help='Whether to save deterministic probe-set input references under probe_set_reference/.')
