...
from .snn_network_blocks import Snn_BaseConv, Snn_DWConv
...
class YOLOXHead(nn.Module):
    ...
    def forward(self, xin, labels=None, imgs=None):
        ...
        for k, (cls_conv, reg_conv, stride_this_level, x) in enumerate(
            ...
            cls_output = self.cls_preds[k](cls_feat.mean(0))

            reg_feat = reg_conv(reg_x)
            reg_output = self.reg_preds[k](reg_feat.mean(0))
            obj_output = self.obj_preds[k](reg_feat.mean(0))
