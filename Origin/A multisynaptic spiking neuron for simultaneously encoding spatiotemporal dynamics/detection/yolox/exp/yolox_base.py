...
class Exp(BaseExp):
    ...
    def get_optimizer(self, batch_size):
        if "optimizer" not in self.__dict__:
            ...
            pg3, pg4, pg5 = [], [], []  #  optimizer parameter PLIF
            for k, v in self.model.named_modules():
                ...
                if hasattr(v,"w"):  #PLIF self.w
                    pg3.append(v.w)
                if hasattr(v,"v_threshold"):
                    pg4.append(v.v_threshold)
                # if hasattr(v,"ws"):
                    # pg5.append(v.ws)                    
            ...
            optimizer.add_param_group({"params": pg4})
            # optimizer.add_param_group({"params": pg5})
