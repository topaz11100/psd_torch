...
CONFIG_GROUP_0=(
    "/home/yongokhan/workspace/code/psd/config/neuron_characterization_scenarios/psd_analysis/control/simple/shd_rf_none_fixed-2.yaml"
    "/home/yongokhan/workspace/code/psd/config/neuron_characterization_scenarios/psd_analysis/control/simple/shd_rf_none_fixed.yaml"
)
...
launch_config() {
    ...
    CONFIG_PATH="$CONFIG_PATH" nohup bash -c 'python src/psd_analysis.py --config "$CONFIG_PATH"' > "$LOG_PATH" 2>&1 &
    PID="$!"
    LAST_PID="$PID"
    echo "STAGE=${STAGE}"
