...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/yongokhan/바탕화면/new/uci}"
...
BASE_SET_RAW="${BASE_SET:-uci-har|128,64,64}"
...
MODEL_SLOT_SET_RAW="${MODEL_SLOT_SET:-lif_soft_fixed|1}"
...
REGULARIZATION_SET_RAW="0|0|y_spike|exact|db|raw|mean 0.001|0|y_spike|exact|db|raw|mean -0.001|0|y_spike|exact|db|raw|mean 0|0.001|y_spike|exact|db|raw|mean 0|-0.001|y_spike|exact|db|raw|mean"
