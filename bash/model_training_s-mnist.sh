...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/yongokhan/바탕화면/new/s-mnist}"
...
REGULARIZATION_SET_RAW="0|0.001|y_spike|exact|db|raw|mean 0|-0.001|y_spike|exact|db|raw|mean"
...
REGULARIZATION_DISTANCE_METRIC="${REGULARIZATION_DISTANCE_METRIC:-diff_l2}"
